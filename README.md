...
- Go to Rocket Test Site and wait for a test launch, once the launch is over run outside quickly and shoot the red glowing rock quickly. (As you exit the safe room towards the rocket look on top of the ledge at your 400)
...
- Shoot the Corresponding symbols on the ground that you got from the knights. THE SYMBOLS MUST BE IN THE SAME ORDER AS THE KNIGHTS PICTURES (Example Griffin=Circle, Door=Square, Heart=Triangle. So the code to input - would be Circle, Square, Triangle.)
...
- Stop the clock on 935, the clock will zap with lightning and go to 936.
